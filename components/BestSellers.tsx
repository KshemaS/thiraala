        ...
        {bestSellers.map((saree) => (
          ...
          >
            ...
            <div className="mt-6 text-center flex flex-col items-center">
              ...
              <button className="text-[11px] font-bold text-[#1E3A2C] group-hover:text-[#0c2b1c] flex items-center gap-1 mt-3 transition-colors border-b border-[#1E3A2C]/20 hover:border-[#0c2b1c] pb-0.5 cursor-pointer">
                View Collection
